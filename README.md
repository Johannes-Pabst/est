...
- "... the fourth month only has the name 'April' in even-numbered years, and is otherwise unnamed."
    - this means the CONVERTED ETC year, not the CURRENT ETC year. e.g.: it's 2026 and you convert a date to 1.4.2025 EST. In this case, the date is NOT spoken "first of april 2025" despite it currently being an even year, because the converted date is an odd year.
